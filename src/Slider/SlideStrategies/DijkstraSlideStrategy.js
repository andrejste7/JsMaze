            ...
            this.slider.addSlide(
                new Slide({
                    ...
                    slideContent: new RepeatSlide(
                        ...
                        (repeatSlide) => {
                            repeatSlide.resultsElement.innerHTML = `Labirints ${maze.mazeSize}x${maze.mazeSize}, izmantojot DIJKSTRA tika atrisināts ar ${maze.result.length.toString()} soļiem`;
